...
public class PetCursorAdapter extends CursorAdapter {
     ...
     * @param context   app context
     * @param c         The cursor from which to get the data. The cursor is already moved to the
     *                  correct row.
     */
    public void bindView(View view, Context context, Cursor c) {
        ...
        String petName = c.getString(c.getColumnIndexOrThrow(PetEntry.COLUMN_PET_NAME));
        String petSummary = c.getString(c.getColumnIndexOrThrow(PetEntry.COLUMN_PET_BREED));
